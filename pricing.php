				...
				<div class="row items-center mb-lg">
					<div class="column align-left">
						<a href="https://wikiforge.net" aria-current="page" class="w-inline-block w--current">
							<div class="logo">
								<img src="/images/WikiForge_Wordmark.svg" width="175" alt="WikiForge" />
							</div>
						</a>
					</div>
					<div class="column align-right">
						<div class="row items-center">
							<a href="https://wikiforge.net" class="u mr-lg">Home</a>
				...
				<div class="row v-l">
					<div class="column align-left">
						...
						<div class="row mt-lg ml-md-n">
							...
							<a href="https://twitter.com/WikiForge" target="_blank" class="p-md w-inline-block">
								<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon">
									<path d="M23 3a10.9 10.9 0 0 1-3.14 1.53 4.48 4.48 0 0 0-7.86 3v1A10.66 10.66 0 0 1 3 4s-4 9 5 13a11.64 11.64 0 0 1-7 2c9 5 20 0 20-11.5a4.5 4.5 0 0 0-.08-.83A7.72 7.72 0 0 0 23 3z"></path>
								</svg>
							</a>
							<a href="https://mastodon.social/@WikiForge" target="_blank" class="p-md w-inline-block">
								<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 192 192" fill="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon">
							...
							<a href="https://www.reddit.com/r/WikiForgeIt" target="_blank" class="p-md w-inline-block">
								<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="-268 289.4 262.6 222.6" fill="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon">
									<g>
							...
							<a href="https://wikiforge.net/discord" target="_blank" class="p-md w-inline-block">
								<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 -28.5 256 256" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon">
					...
					<div class="column align-left">
						...
						<a href="mailto: support@wikiforge.net">Support</a>
						<a href="mailto: sales@wikiforge.net" class="mt-md">Sales</a>
					</div>
					<div class="column align-left">
